        ...
        <section class="w-full">
          <section class="mb-20">
            <div
              ...
              data-monster-type="{{ strtolower($monster->monster_type->name) }}"
            >
              <div class="md:flex">
                <!-- Image du monstre -->
                ...
                <div class="p-6 md:w-1/2">
                  ...
                  <div class="mb-4">
                    <div>
                      ...
                      <span class="text-gray-300">{{ $monster->monster_type->name }}</span>
                    </div>
                    <div>
                  ...
                  <div class="">
                    ...
                    > --> --}}
                    <a
                      href="{{ route('posts.edit', ['id' => $monster->id])}}"
                      class="inline-block text-white bg-red-500 hover:bg-red-700 rounded-full px-4 py-2 transition-colors duration-300"
                      >Modifier</a
                    >
                    <form class="inline-block text-white opacity-60 hover:opacity-100 rounded-full px-4 py-2 transition-colors duration-300"
                    action="{{ route('monster.destroy', $monster->id) }}" method="POST"
                    >
                    @csrf
                    @method('DELETE')
                    <button type="submit">
