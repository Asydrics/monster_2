            ...
            <main class="w-full md:w-3/4 p-4">
                ...
                <section class="mb-20">
                    ...
                    <div class="w-full md:w-1/2 relative">
                        ...
                        src="{{ asset('images/' . $randomMonster->image_url) }}"
                        alt="Nom du Monstre"
                        />
                    ...
                    <div class="p-6 md:w-1/2">
                        ...
                        <span class="text-red-400"> {{ $randomMonster->user_id}}</span>
                        </div>
                        <div class="mb-4">
                        <div>
                        ...
                        <div>
                            ...
                            <span class="text-gray-300">{{ $randomMonster->pv}}</span>
                        </div>
                        <div>
                            <strong class="text-white">Attaque:</strong>
                            <span class="text-gray-300">{{ $randomMonster->attack}}</span>
                        </div>
                        <div>
                            <strong class="text-white">Défense:</strong>
                            <span class="text-gray-300">{{ $randomMonster->defense}}</span>
                        </div>
                        </div>
                        <div class="mb-4">
